...
public class DefaultTreeProvider extends SurfaceObjectProvider<Biome, TreeGenerator> implements ConfigurableFacetProvider {
    ...
    public DefaultTreeProvider() {
        register(ShatteredPlanesBiome.MOUNTAINS, Trees.oakTree(), 0.04f);
        register(ShatteredPlanesBiome.MOUNTAINS, Trees.pineTree(), 0.02f);

        register(ShatteredPlanesBiome.FOREST, Trees.oakTree(), 0.25f);
        register(ShatteredPlanesBiome.FOREST, Trees.pineTree(), 0.10f);
        register(ShatteredPlanesBiome.FOREST, Trees.birchTree(), 0.10f);
        register(ShatteredPlanesBiome.FOREST, Trees.oakVariationTree(), 0.25f);

        register(ShatteredPlanesBiome.SNOW, Trees.birchTree(), 0.02f);
        register(ShatteredPlanesBiome.SNOW, Trees.pineTree(), 0.10f);

        register(ShatteredPlanesBiome.PLAINS, Trees.redTree(), 0.01f);
        register(ShatteredPlanesBiome.PLAINS, Trees.birchTree(), 0.01f);
        register(ShatteredPlanesBiome.PLAINS, Trees.oakTree(), 0.02f);

        register(ShatteredPlanesBiome.DESERT, Trees.cactus(), 0.04f);
    }
